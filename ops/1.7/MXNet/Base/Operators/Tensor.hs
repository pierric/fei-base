...
type instance ParameterList "__CachedOpThreadSafe" t =
     '[ '("data", AttrOpt [t])]

__CachedOpThreadSafe ::
                     forall a t .
                       (TensorOp t t, Fullfilled "__CachedOpThreadSafe" t a,
                        HasCallStack) =>
                       ArgsHMap "__CachedOpThreadSafe" t a -> TensorApply t
__CachedOpThreadSafe args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #data :: Maybe [t])
      in apply "_CachedOpThreadSafe" scalarArgs (Right tensorVarArgs)
...
__backward__contrib_ModulatedDeformableConvolution args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward__contrib_ModulatedDeformableConvolution"
        scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_broadcast_exponential" t =
     '[ '("scale", AttrOpt (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text)]

__backward_broadcast_exponential ::
                                 forall a t .
                                   (TensorOp t t, Fullfilled "__backward_broadcast_exponential" t a,
                                    HasCallStack) =>
                                   ArgsHMap "__backward_broadcast_exponential" t a -> TensorApply t
__backward_broadcast_exponential args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_exponential" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_broadcast_gumbel" t =
...
__backward_broadcast_gumbel ::
                            forall a t .
                              (TensorOp t t, Fullfilled "__backward_broadcast_gumbel" t a,
                               HasCallStack) =>
                              ArgsHMap "__backward_broadcast_gumbel" t a -> TensorApply t
__backward_broadcast_gumbel args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_gumbel" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_broadcast_logistic" t =
     '[ '("loc", AttrReq (Maybe Float)),
        '("scale", AttrReq (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text)]
...
__backward_broadcast_logistic ::
                              forall a t .
                                (TensorOp t t, Fullfilled "__backward_broadcast_logistic" t a,
                                 HasCallStack) =>
                                ArgsHMap "__backward_broadcast_logistic" t a -> TensorApply t
__backward_broadcast_logistic args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_logistic" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_broadcast_normal" t =
     '[ '("loc", AttrReq (Maybe Float)),
        '("scale", AttrReq (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text),
...
__backward_broadcast_normal ::
                            forall a t .
                              (TensorOp t t, Fullfilled "__backward_broadcast_normal" t a,
                               HasCallStack) =>
                              ArgsHMap "__backward_broadcast_normal" t a -> TensorApply t
__backward_broadcast_normal args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_normal" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_broadcast_pareto" t =
     '[ '("a", AttrOpt (Maybe Float)), '("size", AttrOpt (Maybe [Int])),
        '("ctx", AttrOpt Text)]

__backward_broadcast_pareto ::
                            forall a t .
                              (TensorOp t t, Fullfilled "__backward_broadcast_pareto" t a,
                               HasCallStack) =>
                              ArgsHMap "__backward_broadcast_pareto" t a -> TensorApply t
__backward_broadcast_pareto args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_pareto" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_broadcast_rayleigh" t =
     '[ '("scale", AttrOpt (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text)]

__backward_broadcast_rayleigh ::
                              forall a t .
                                (TensorOp t t, Fullfilled "__backward_broadcast_rayleigh" t a,
                                 HasCallStack) =>
                                ArgsHMap "__backward_broadcast_rayleigh" t a -> TensorApply t
__backward_broadcast_rayleigh args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_rayleigh" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_broadcast_weibull" t =
     '[ '("a", AttrOpt (Maybe Float)), '("size", AttrOpt (Maybe [Int])),
        '("ctx", AttrOpt Text)]

__backward_broadcast_weibull ::
                             forall a t .
                               (TensorOp t t, Fullfilled "__backward_broadcast_weibull" t a,
                                HasCallStack) =>
                               ArgsHMap "__backward_broadcast_weibull" t a -> TensorApply t
__backward_broadcast_weibull args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_broadcast_weibull" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_col2im" t = '[]

__backward_col2im ::
                  forall a t .
                    (TensorOp t t, Fullfilled "__backward_col2im" t a, HasCallStack) =>
                    ArgsHMap "__backward_col2im" t a -> TensorApply t
__backward_col2im args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_col2im" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_im2col" t = '[]

__backward_im2col ::
                  forall a t .
                    (TensorOp t t, Fullfilled "__backward_im2col" t a, HasCallStack) =>
                    ArgsHMap "__backward_im2col" t a -> TensorApply t
__backward_im2col args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_im2col" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_np_average" t = '[]

__backward_np_average ::
                      forall a t .
                        (TensorOp t t, Fullfilled "__backward_np_average" t a,
                         HasCallStack) =>
                        ArgsHMap "__backward_np_average" t a -> TensorApply t
__backward_np_average args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_average" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_np_diag" t = '[]

__backward_np_diag ::
                   forall a t .
                     (TensorOp t t, Fullfilled "__backward_np_diag" t a,
                      HasCallStack) =>
                     ArgsHMap "__backward_np_diag" t a -> TensorApply t
__backward_np_diag args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_diag" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_np_diagflat" t = '[]

__backward_np_diagflat ::
                       forall a t .
                         (TensorOp t t, Fullfilled "__backward_np_diagflat" t a,
                          HasCallStack) =>
                         ArgsHMap "__backward_np_diagflat" t a -> TensorApply t
__backward_np_diagflat args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_diagflat" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_np_diagonal" t = '[]

__backward_np_diagonal ::
                       forall a t .
                         (TensorOp t t, Fullfilled "__backward_np_diagonal" t a,
                          HasCallStack) =>
                         ArgsHMap "__backward_np_diagonal" t a -> TensorApply t
__backward_np_diagonal args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_diagonal" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_np_hstack" t = '[]

__backward_np_hstack ::
                     forall a t .
                       (TensorOp t t, Fullfilled "__backward_np_hstack" t a,
                        HasCallStack) =>
                       ArgsHMap "__backward_np_hstack" t a -> TensorApply t
__backward_np_hstack args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_hstack" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_np_matmul" t = '[]

__backward_np_matmul ::
                     forall a t .
                       (TensorOp t t, Fullfilled "__backward_np_matmul" t a,
                        HasCallStack) =>
                       ArgsHMap "__backward_np_matmul" t a -> TensorApply t
__backward_np_matmul args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_matmul" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_np_where" t = '[]

__backward_np_where ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__backward_np_where" t a,
                       HasCallStack) =>
                      ArgsHMap "__backward_np_where" t a -> TensorApply t
__backward_np_where args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_where" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_np_where_lscalar" t = '[]

__backward_np_where_lscalar ::
                            forall a t .
                              (TensorOp t t, Fullfilled "__backward_np_where_lscalar" t a,
                               HasCallStack) =>
                              ArgsHMap "__backward_np_where_lscalar" t a -> TensorApply t
__backward_np_where_lscalar args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_where_lscalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_np_where_rscalar" t = '[]

__backward_np_where_rscalar ::
                            forall a t .
                              (TensorOp t t, Fullfilled "__backward_np_where_rscalar" t a,
                               HasCallStack) =>
                              ArgsHMap "__backward_np_where_rscalar" t a -> TensorApply t
__backward_np_where_rscalar args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_np_where_rscalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_npi_broadcast_add" t = '[]

__backward_npi_broadcast_add ::
                             forall a t .
                               (TensorOp t t, Fullfilled "__backward_npi_broadcast_add" t a,
                                HasCallStack) =>
                               ArgsHMap "__backward_npi_broadcast_add" t a -> TensorApply t
__backward_npi_broadcast_add args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_broadcast_add" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_npi_broadcast_div" t = '[]

__backward_npi_broadcast_div ::
                             forall a t .
                               (TensorOp t t, Fullfilled "__backward_npi_broadcast_div" t a,
                                HasCallStack) =>
                               ArgsHMap "__backward_npi_broadcast_div" t a -> TensorApply t
__backward_npi_broadcast_div args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_broadcast_div" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_npi_broadcast_mod" t = '[]

__backward_npi_broadcast_mod ::
                             forall a t .
                               (TensorOp t t, Fullfilled "__backward_npi_broadcast_mod" t a,
                                HasCallStack) =>
                               ArgsHMap "__backward_npi_broadcast_mod" t a -> TensorApply t
__backward_npi_broadcast_mod args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_broadcast_mod" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_npi_broadcast_power" t =
     '[]

__backward_npi_broadcast_power ::
                               forall a t .
                                 (TensorOp t t, Fullfilled "__backward_npi_broadcast_power" t a,
                                  HasCallStack) =>
                                 ArgsHMap "__backward_npi_broadcast_power" t a -> TensorApply t
__backward_npi_broadcast_power args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_broadcast_power" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_npi_broadcast_sub" t = '[]

__backward_npi_broadcast_sub ::
                             forall a t .
                               (TensorOp t t, Fullfilled "__backward_npi_broadcast_sub" t a,
                                HasCallStack) =>
                               ArgsHMap "__backward_npi_broadcast_sub" t a -> TensorApply t
__backward_npi_broadcast_sub args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_broadcast_sub" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_npi_norm" t = '[]

__backward_npi_norm ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__backward_npi_norm" t a,
                       HasCallStack) =>
                      ArgsHMap "__backward_npi_norm" t a -> TensorApply t
__backward_npi_norm args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_norm" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_npi_pad" t = '[]

__backward_npi_pad ::
                   forall a t .
                     (TensorOp t t, Fullfilled "__backward_npi_pad" t a,
                      HasCallStack) =>
                     ArgsHMap "__backward_npi_pad" t a -> TensorApply t
__backward_npi_pad args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_pad" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_npi_solve" t = '[]

__backward_npi_solve ::
                     forall a t .
                       (TensorOp t t, Fullfilled "__backward_npi_solve" t a,
                        HasCallStack) =>
                       ArgsHMap "__backward_npi_solve" t a -> TensorApply t
__backward_npi_solve args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_solve" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__backward_npi_tensorinv" t = '[]

__backward_npi_tensorinv ::
                         forall a t .
                           (TensorOp t t, Fullfilled "__backward_npi_tensorinv" t a,
                            HasCallStack) =>
                           ArgsHMap "__backward_npi_tensorinv" t a -> TensorApply t
__backward_npi_tensorinv args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_tensorinv" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__backward_npi_tensorsolve" t = '[]

__backward_npi_tensorsolve ::
                           forall a t .
                             (TensorOp t t, Fullfilled "__backward_npi_tensorsolve" t a,
                              HasCallStack) =>
                             ArgsHMap "__backward_npi_tensorsolve" t a -> TensorApply t
__backward_npi_tensorsolve args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_backward_npi_tensorsolve" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__contrib_BilinearResize2D" t =
     '[ '("height", AttrOpt Int), '("width", AttrOpt Int),
        ...
        '("align_corners", AttrOpt Bool), '("data", AttrOpt t),
        '("like", AttrOpt t)]
...
type instance
     ParameterList "__contrib_ModulatedDeformableConvolution" t =
     '[ '("kernel", AttrReq [Int]), '("stride", AttrOpt [Int]),
        '("dilate", AttrOpt [Int]), '("pad", AttrOpt [Int]),
        '("num_filter", AttrReq Int), '("num_group", AttrOpt Int),
        '("num_deformable_group", AttrOpt Int),
        ...
        '("layout", AttrOpt (Maybe (EnumType '["NCDHW", "NCHW", "NCW"]))),
        '("data", AttrOpt t), '("offset", AttrOpt t), '("mask", AttrOpt t),
        '("weight", AttrOpt t), '("bias", AttrOpt t)]

__contrib_ModulatedDeformableConvolution ::
                                         forall a t .
                                           (TensorOp t t,
                                            Fullfilled "__contrib_ModulatedDeformableConvolution" t
                                              a,
                                            HasCallStack) =>
                                           ArgsHMap "__contrib_ModulatedDeformableConvolution" t a
                                             -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe t),
               ...
               ("bias",) <$> (args !? #bias :: Maybe t)]
      in
      apply "_contrib_ModulatedDeformableConvolution" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__contrib_mrcnn_mask_target" t =
     '[ '("num_rois", AttrReq Int), '("num_classes", AttrReq Int),
        ...
        '("aligned", AttrOpt Bool), '("rois", AttrOpt t),
        '("gt_masks", AttrOpt t), '("matches", AttrOpt t),
        '("cls_targets", AttrOpt t)]
...
type instance ParameterList "__contrib_quantized_elemwise_mul" t =
     '[ '("min_calib_range", AttrOpt (Maybe Float)),
        '("max_calib_range", AttrOpt (Maybe Float)),
        '("enable_float_output", AttrOpt Bool), '("lhs", AttrOpt t),
        '("rhs", AttrOpt t), '("lhs_min", AttrOpt t),
        '("lhs_max", AttrOpt t), '("rhs_min", AttrOpt t),
        '("rhs_max", AttrOpt t)]
...
__contrib_quantized_elemwise_mul ::
                                 forall a t .
                                   (TensorOp t t, Fullfilled "__contrib_quantized_elemwise_mul" t a,
                                    HasCallStack) =>
                                   ArgsHMap "__contrib_quantized_elemwise_mul" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("lhs",) <$> (args !? #lhs :: Maybe t),
               ...
               ("rhs_max",) <$> (args !? #rhs_max :: Maybe t)]
      in
      apply "_contrib_quantized_elemwise_mul" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__contrib_quantized_embedding" t =
     '[ '("input_dim", AttrReq Int), '("output_dim", AttrReq Int),
        '("dtype",
          AttrOpt
            (EnumType
               '["bfloat16", "float16", "float32", "float64", "int32", "int64",
                 "int8", "uint8"])),
        '("sparse_grad", AttrOpt Bool), '("data", AttrOpt t),
        '("weight", AttrOpt t), '("min_weight", AttrOpt t),
        '("max_weight", AttrOpt t)]

__contrib_quantized_embedding ::
                              forall a t .
                                (TensorOp t t, Fullfilled "__contrib_quantized_embedding" t a,
                                 HasCallStack) =>
                                ArgsHMap "__contrib_quantized_embedding" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe t),
               ...
               ("max_weight",) <$> (args !? #max_weight :: Maybe t)]
      in
      apply "_contrib_quantized_embedding" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__multi_lamb_update" t =
     '[ '("learning_rates", AttrReq [Float]), '("beta1", AttrOpt Float),
        ...
        '("num_tensors", AttrOpt Int), '("data", AttrOpt [t])]

__multi_lamb_update ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__multi_lamb_update" t a,
                       HasCallStack) =>
                      ArgsHMap "__multi_lamb_update" t a -> TensorApply t
__multi_lamb_update args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #data :: Maybe [t])
      in apply "_multi_lamb_update" scalarArgs (Right tensorVarArgs)
...
type instance ParameterList "__multi_mp_lamb_update" t =
     '[ '("learning_rates", AttrReq [Float]), '("beta1", AttrOpt Float),
        '("beta2", AttrOpt Float), '("epsilon", AttrOpt Float),
        '("wds", AttrReq [Float]), '("rescale_grad", AttrOpt Float),
        '("lower_bound", AttrOpt Float), '("upper_bound", AttrOpt Float),
...
__multi_mp_lamb_update ::
                       forall a t .
                         (TensorOp t t, Fullfilled "__multi_mp_lamb_update" t a,
                          HasCallStack) =>
                         ArgsHMap "__multi_mp_lamb_update" t a -> TensorApply t
__multi_mp_lamb_update args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #data :: Maybe [t])
      in apply "_multi_mp_lamb_update" scalarArgs (Right tensorVarArgs)
...
type instance ParameterList "__np_all" t =
     '[ '("axis", AttrOpt (Maybe [Int])), '("keepdims", AttrOpt Bool),
        '("data", AttrOpt t)]

__np_all ::
         forall a t .
           (TensorOp t t, Fullfilled "__np_all" t a, HasCallStack) =>
           ArgsHMap "__np_all" t a -> TensorApply t
__np_all args
  = let scalarArgs
          = catMaybes
              [("axis",) . showValue <$> (args !? #axis :: Maybe (Maybe [Int])),
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in apply "_np_all" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__np_any" t =
     '[ '("axis", AttrOpt (Maybe [Int])), '("keepdims", AttrOpt Bool),
        '("data", AttrOpt t)]

__np_any ::
         forall a t .
           (TensorOp t t, Fullfilled "__np_any" t a, HasCallStack) =>
           ArgsHMap "__np_any" t a -> TensorApply t
__np_any args
  = let scalarArgs
          = catMaybes
              [("axis",) . showValue <$> (args !? #axis :: Maybe (Maybe [Int])),
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in apply "_np_any" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__np_atleast_1d" t =
     '[ '("num_args", AttrReq Int), '("arys", AttrOpt [t])]

__np_atleast_1d ::
                forall a t .
                  (TensorOp t t, Fullfilled "__np_atleast_1d" t a, HasCallStack) =>
                  ArgsHMap "__np_atleast_1d" t a -> TensorApply t
__np_atleast_1d args
  = let scalarArgs
          = catMaybes
              [("num_args",) . showValue <$> (args !? #num_args :: Maybe Int)]
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #arys :: Maybe [t])
      in apply "_np_atleast_1d" scalarArgs (Right tensorVarArgs)

type instance ParameterList "__np_atleast_2d" t =
     '[ '("num_args", AttrReq Int), '("arys", AttrOpt [t])]

__np_atleast_2d ::
                forall a t .
                  (TensorOp t t, Fullfilled "__np_atleast_2d" t a, HasCallStack) =>
                  ArgsHMap "__np_atleast_2d" t a -> TensorApply t
__np_atleast_2d args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #arys :: Maybe [t])
      in apply "_np_atleast_2d" scalarArgs (Right tensorVarArgs)

type instance ParameterList "__np_atleast_3d" t =
     '[ '("num_args", AttrReq Int), '("arys", AttrOpt [t])]

__np_atleast_3d ::
                forall a t .
                  (TensorOp t t, Fullfilled "__np_atleast_3d" t a, HasCallStack) =>
                  ArgsHMap "__np_atleast_3d" t a -> TensorApply t
__np_atleast_3d args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #arys :: Maybe [t])
      in apply "_np_atleast_3d" scalarArgs (Right tensorVarArgs)
...
type instance ParameterList "__np_diag" t =
     '[ '("k", AttrOpt Int), '("data", AttrOpt t)]

__np_diag ::
          forall a t .
            (TensorOp t t, Fullfilled "__np_diag" t a, HasCallStack) =>
            ArgsHMap "__np_diag" t a -> TensorApply t
__np_diag args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_np_diag" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__np_diagflat" t =
     '[ '("k", AttrOpt Int), '("data", AttrOpt t)]

__np_diagflat ::
              forall a t .
                (TensorOp t t, Fullfilled "__np_diagflat" t a, HasCallStack) =>
                ArgsHMap "__np_diagflat" t a -> TensorApply t
__np_diagflat args
  = let scalarArgs
          = catMaybes [("k",) . showValue <$> (args !? #k :: Maybe Int)]
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_np_diagflat" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__np_diagonal" t =
     '[ '("offset", AttrOpt Int), '("axis1", AttrOpt Int),
        '("axis2", AttrOpt Int), '("data", AttrOpt t)]

__np_diagonal ::
              forall a t .
                (TensorOp t t, Fullfilled "__np_diagonal" t a, HasCallStack) =>
                ArgsHMap "__np_diagonal" t a -> TensorApply t
__np_diagonal args
  = let scalarArgs
          = catMaybes
              [("offset",) . showValue <$> (args !? #offset :: Maybe Int),
...
type instance ParameterList "__npi_average" t =
     '[ '("axis", AttrOpt (Maybe [Int])), '("returned", AttrOpt Bool),
        '("weighted", AttrOpt Bool), '("a", AttrOpt t),
        '("weights", AttrOpt t)]

__npi_average ::
              forall a t .
                (TensorOp t t, Fullfilled "__npi_average" t a, HasCallStack) =>
                ArgsHMap "__npi_average" t a -> TensorApply t
__npi_average args
  = let scalarArgs
          = catMaybes
              [("axis",) . showValue <$> (args !? #axis :: Maybe (Maybe [Int])),
        ...
        tensorKeyArgs
          = catMaybes
              [("a",) <$> (args !? #a :: Maybe t),
               ("weights",) <$> (args !? #weights :: Maybe t)]
      in
      apply "_npi_average" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_backward_ediff1d" t = '[]

__npi_backward_ediff1d ::
                       forall a t .
                         (TensorOp t t, Fullfilled "__npi_backward_ediff1d" t a,
                          HasCallStack) =>
                         ArgsHMap "__npi_backward_ediff1d" t a -> TensorApply t
__npi_backward_ediff1d args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_npi_backward_ediff1d" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_backward_nan_to_num" t = '[]

__npi_backward_nan_to_num ::
                          forall a t .
                            (TensorOp t t, Fullfilled "__npi_backward_nan_to_num" t a,
                             HasCallStack) =>
                            ArgsHMap "__npi_backward_nan_to_num" t a -> TensorApply t
__npi_backward_nan_to_num args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_npi_backward_nan_to_num" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_backward_polyval" t = '[]

__npi_backward_polyval ::
                       forall a t .
                         (TensorOp t t, Fullfilled "__npi_backward_polyval" t a,
                          HasCallStack) =>
                         ArgsHMap "__npi_backward_polyval" t a -> TensorApply t
__npi_backward_polyval args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes []
      in
      apply "_npi_backward_polyval" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bernoulli" t =
     '[ '("prob", AttrReq (Maybe Float)),
        ...
        '("is_logit", AttrReq Bool), '("input1", AttrOpt t)]

__npi_bernoulli ::
                forall a t .
                  (TensorOp t t, Fullfilled "__npi_bernoulli" t a, HasCallStack) =>
                  ArgsHMap "__npi_bernoulli" t a -> TensorApply t
__npi_bernoulli args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("input1",) <$> (args !? #input1 :: Maybe t)]
      in
      apply "_npi_bernoulli" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bincount" t =
     '[ '("minlength", AttrOpt Int), '("has_weights", AttrOpt Bool),
        '("data", AttrOpt t), '("weights", AttrOpt t)]

__npi_bincount ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_bincount" t a, HasCallStack) =>
                 ArgsHMap "__npi_bincount" t a -> TensorApply t
__npi_bincount args
  = let scalarArgs
          = catMaybes
        ...
        tensorKeyArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe t),
               ("weights",) <$> (args !? #weights :: Maybe t)]
      in
      apply "_npi_bincount" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bitwise_and" t =
     '[ '("lhs", AttrOpt t), '("rhs", AttrOpt t)]

__npi_bitwise_and ::
                  forall a t .
                    (TensorOp t t, Fullfilled "__npi_bitwise_and" t a, HasCallStack) =>
                    ArgsHMap "__npi_bitwise_and" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("lhs",) <$> (args !? #lhs :: Maybe t),
               ("rhs",) <$> (args !? #rhs :: Maybe t)]
      in
      apply "_npi_bitwise_and" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bitwise_and_scalar" t =
     '[ '("scalar", AttrOpt Double), '("is_int", AttrOpt Bool),
        '("data", AttrOpt t)]

__npi_bitwise_and_scalar ::
                         forall a t .
                           (TensorOp t t, Fullfilled "__npi_bitwise_and_scalar" t a,
                            HasCallStack) =>
                           ArgsHMap "__npi_bitwise_and_scalar" t a -> TensorApply t
__npi_bitwise_and_scalar args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_npi_bitwise_and_scalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bitwise_not" t =
     '[ '("x", AttrOpt t)]

__npi_bitwise_not ::
                  forall a t .
                    (TensorOp t t, Fullfilled "__npi_bitwise_not" t a, HasCallStack) =>
                    ArgsHMap "__npi_bitwise_not" t a -> TensorApply t
__npi_bitwise_not args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_bitwise_not" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bitwise_or" t =
     '[ '("lhs", AttrOpt t), '("rhs", AttrOpt t)]

__npi_bitwise_or ::
                 forall a t .
                   (TensorOp t t, Fullfilled "__npi_bitwise_or" t a, HasCallStack) =>
                   ArgsHMap "__npi_bitwise_or" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("lhs",) <$> (args !? #lhs :: Maybe t),
               ("rhs",) <$> (args !? #rhs :: Maybe t)]
      in
      apply "_npi_bitwise_or" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_bitwise_or_scalar" t =
     '[ '("scalar", AttrOpt Double), '("is_int", AttrOpt Bool),
        '("data", AttrOpt t)]

__npi_bitwise_or_scalar ::
                        forall a t .
                          (TensorOp t t, Fullfilled "__npi_bitwise_or_scalar" t a,
                           HasCallStack) =>
                          ArgsHMap "__npi_bitwise_or_scalar" t a -> TensorApply t
__npi_bitwise_or_scalar args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_npi_bitwise_or_scalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_boolean_mask_assign_tensor" t =
     '[ '("start_axis", AttrOpt Int), '("data", AttrOpt t),
        '("mask", AttrOpt t), '("value", AttrOpt t)]
...
type instance ParameterList "__npi_broadcast_to" t =
     '[ '("shape", AttrOpt [Int]), '("array", AttrOpt t)]

__npi_broadcast_to ::
                   forall a t .
                     (TensorOp t t, Fullfilled "__npi_broadcast_to" t a,
                      HasCallStack) =>
                     ArgsHMap "__npi_broadcast_to" t a -> TensorApply t
__npi_broadcast_to args
  = let scalarArgs
      ...
      in
      apply "_npi_broadcast_to" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_cholesky" t =
     '[ '("a", AttrOpt t)]

__npi_cholesky ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_cholesky" t a, HasCallStack) =>
                 ArgsHMap "__npi_cholesky" t a -> TensorApply t
__npi_cholesky args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_cholesky" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_delete" t =
     '[ '("start", AttrOpt (Maybe Int)), '("stop", AttrOpt (Maybe Int)),
        '("step", AttrOpt (Maybe Int)), '("int_ind", AttrOpt (Maybe Int)),
        '("axis", AttrOpt (Maybe Int)), '("arr", AttrOpt t),
        '("obj", AttrOpt t)]

__npi_delete ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_delete" t a, HasCallStack) =>
               ArgsHMap "__npi_delete" t a -> TensorApply t
__npi_delete args
  = let scalarArgs
          = catMaybes
        ...
        tensorKeyArgs
          = catMaybes
              [("arr",) <$> (args !? #arr :: Maybe t),
               ("obj",) <$> (args !? #obj :: Maybe t)]
      in
      apply "_npi_delete" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_diag_indices_from" t =
     '[ '("data", AttrOpt t)]

__npi_diag_indices_from ::
                        forall a t .
                          (TensorOp t t, Fullfilled "__npi_diag_indices_from" t a,
                           HasCallStack) =>
                          ArgsHMap "__npi_diag_indices_from" t a -> TensorApply t
__npi_diag_indices_from args
  = let scalarArgs = catMaybes []
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_npi_diag_indices_from" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_dsplit" t =
...
__npi_dsplit ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_dsplit" t a, HasCallStack) =>
               ArgsHMap "__npi_dsplit" t a -> TensorApply t
__npi_dsplit args
  = let scalarArgs
          = catMaybes
...
type instance ParameterList "__npi_ediff1d" t =
     '[ '("to_begin_arr_given", AttrOpt Bool),
        '("to_end_arr_given", AttrOpt Bool),
        '("to_begin_scalar", AttrOpt (Maybe Double)),
        '("to_end_scalar", AttrOpt (Maybe Double)), '("input1", AttrOpt t),
        '("input2", AttrOpt t), '("input3", AttrOpt t)]

__npi_ediff1d ::
              forall a t .
                (TensorOp t t, Fullfilled "__npi_ediff1d" t a, HasCallStack) =>
                ArgsHMap "__npi_ediff1d" t a -> TensorApply t
__npi_ediff1d args
  = let scalarArgs
          = catMaybes
        ...
        tensorKeyArgs
          = catMaybes
              [("input1",) <$> (args !? #input1 :: Maybe t),
               ("input2",) <$> (args !? #input2 :: Maybe t),
               ("input3",) <$> (args !? #input3 :: Maybe t)]
      in
      apply "_npi_ediff1d" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_eig" t = '[ '("a", AttrOpt t)]

__npi_eig ::
          forall a t .
            (TensorOp t t, Fullfilled "__npi_eig" t a, HasCallStack) =>
            ArgsHMap "__npi_eig" t a -> TensorApply t
__npi_eig args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_eig" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_eigh" t =
     '[ '("uPLO", AttrOpt Int), '("a", AttrOpt t)]

__npi_eigh ::
           forall a t .
             (TensorOp t t, Fullfilled "__npi_eigh" t a, HasCallStack) =>
             ArgsHMap "__npi_eigh" t a -> TensorApply t
__npi_eigh args
  = let scalarArgs
          = catMaybes
        ...
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_eigh" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_eigvals" t =
     '[ '("a", AttrOpt t)]

__npi_eigvals ::
              forall a t .
                (TensorOp t t, Fullfilled "__npi_eigvals" t a, HasCallStack) =>
                ArgsHMap "__npi_eigvals" t a -> TensorApply t
__npi_eigvals args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_eigvals" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_eigvalsh" t =
     '[ '("uPLO", AttrOpt Int), '("a", AttrOpt t)]

__npi_eigvalsh ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_eigvalsh" t a, HasCallStack) =>
                 ArgsHMap "__npi_eigvalsh" t a -> TensorApply t
__npi_eigvalsh args
  = let scalarArgs
          = catMaybes
              [("uPLO",) . showValue <$> (args !? #uPLO :: Maybe Int)]
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_eigvalsh" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_exponential" t =
     '[ '("scale", AttrOpt (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text),
        '("input1", AttrOpt t)]
...
__npi_exponential ::
                  forall a t .
                    (TensorOp t t, Fullfilled "__npi_exponential" t a, HasCallStack) =>
                    ArgsHMap "__npi_exponential" t a -> TensorApply t
__npi_exponential args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("input1",) <$> (args !? #input1 :: Maybe t)]
      in
      apply "_npi_exponential" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_full_like" t =
...
__npi_full_like ::
                forall a t .
                  (TensorOp t t, Fullfilled "__npi_full_like" t a, HasCallStack) =>
                  ArgsHMap "__npi_full_like" t a -> TensorApply t
__npi_full_like args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_full_like" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_gamma" t =
...
__npi_gamma ::
            forall a t .
              (TensorOp t t, Fullfilled "__npi_gamma" t a, HasCallStack) =>
              ArgsHMap "__npi_gamma" t a -> TensorApply t
__npi_gamma args
  = let scalarArgs
          = catMaybes
              [("shape",) . showValue <$>
        ...
        tensorKeyArgs
          = catMaybes
              [("input1",) <$> (args !? #input1 :: Maybe t),
               ("input2",) <$> (args !? #input2 :: Maybe t)]
      in
      apply "_npi_gamma" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_gumbel" t =
     '[ '("loc", AttrReq (Maybe Float)),
        '("scale", AttrReq (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text),
        '("input1", AttrOpt t), '("input2", AttrOpt t)]
...
__npi_gumbel ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_gumbel" t a, HasCallStack) =>
               ArgsHMap "__npi_gumbel" t a -> TensorApply t
__npi_gumbel args
  = let scalarArgs
          = catMaybes
              [("loc",) . showValue <$> (args !? #loc :: Maybe (Maybe Float)),
...
type instance ParameterList "__npi_hstack" t =
     '[ '("num_args", AttrReq Int), '("dim", AttrOpt Int),
        '("data", AttrOpt [t])]

__npi_hstack ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_hstack" t a, HasCallStack) =>
               ArgsHMap "__npi_hstack" t a -> TensorApply t
__npi_hstack args
  = let scalarArgs
          = catMaybes
              [("num_args",) . showValue <$> (args !? #num_args :: Maybe Int),
        ...
        tensorKeyArgs = catMaybes []
        tensorVarArgs = fromMaybe [] (args !? #data :: Maybe [t])
      in apply "_npi_hstack" scalarArgs (Right tensorVarArgs)
...
type instance ParameterList "__npi_insert_scalar" t =
...
__npi_insert_scalar ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__npi_insert_scalar" t a,
                       HasCallStack) =>
                      ArgsHMap "__npi_insert_scalar" t a -> TensorApply t
__npi_insert_scalar args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes
              [("arr",) <$> (args !? #arr :: Maybe t),
               ("values",) <$> (args !? #values :: Maybe t)]
      in
      apply "_npi_insert_scalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_insert_slice" t =
     '[ '("val", AttrOpt (Maybe Double)),
        '("start", AttrOpt (Maybe Int)), '("stop", AttrOpt (Maybe Int)),
        '("step", AttrOpt (Maybe Int)), '("int_ind", AttrOpt (Maybe Int)),
        '("axis", AttrOpt (Maybe Int)), '("arr", AttrOpt t),
...
__npi_insert_slice ::
                   forall a t .
                     (TensorOp t t, Fullfilled "__npi_insert_slice" t a,
                      HasCallStack) =>
                     ArgsHMap "__npi_insert_slice" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("arr",) <$> (args !? #arr :: Maybe t),
               ("values",) <$> (args !? #values :: Maybe t)]
      in
      apply "_npi_insert_slice" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_insert_tensor" t =
     '[ '("val", AttrOpt (Maybe Double)),
        '("start", AttrOpt (Maybe Int)), '("stop", AttrOpt (Maybe Int)),
        '("step", AttrOpt (Maybe Int)), '("int_ind", AttrOpt (Maybe Int)),
        '("axis", AttrOpt (Maybe Int)), '("arr", AttrOpt t),
        '("values", AttrOpt t), '("obj", AttrOpt t)]

__npi_insert_tensor ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__npi_insert_tensor" t a,
                       HasCallStack) =>
                      ArgsHMap "__npi_insert_tensor" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("arr",) <$> (args !? #arr :: Maybe t),
               ...
               ("obj",) <$> (args !? #obj :: Maybe t)]
      in
      apply "_npi_insert_tensor" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_isfinite" t =
     '[ '("x", AttrOpt t)]

__npi_isfinite ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_isfinite" t a, HasCallStack) =>
                 ArgsHMap "__npi_isfinite" t a -> TensorApply t
__npi_isfinite args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_isfinite" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_isinf" t = '[ '("x", AttrOpt t)]

__npi_isinf ::
            forall a t .
              (TensorOp t t, Fullfilled "__npi_isinf" t a, HasCallStack) =>
              ArgsHMap "__npi_isinf" t a -> TensorApply t
__npi_isinf args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_isinf" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_isnan" t = '[ '("x", AttrOpt t)]

__npi_isnan ::
            forall a t .
              (TensorOp t t, Fullfilled "__npi_isnan" t a, HasCallStack) =>
              ArgsHMap "__npi_isnan" t a -> TensorApply t
__npi_isnan args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_isnan" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_isneginf" t =
     '[ '("x", AttrOpt t)]

__npi_isneginf ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_isneginf" t a, HasCallStack) =>
                 ArgsHMap "__npi_isneginf" t a -> TensorApply t
__npi_isneginf args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_isneginf" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_isposinf" t =
     '[ '("x", AttrOpt t)]

__npi_isposinf ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_isposinf" t a, HasCallStack) =>
                 ArgsHMap "__npi_isposinf" t a -> TensorApply t
__npi_isposinf args
  = let scalarArgs = catMaybes []
        tensorKeyArgs = catMaybes [("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_isposinf" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_logistic" t =
     '[ '("loc", AttrReq (Maybe Float)),
        '("scale", AttrReq (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text),
        '("input1", AttrOpt t), '("input2", AttrOpt t)]
...
__npi_logistic ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_logistic" t a, HasCallStack) =>
                 ArgsHMap "__npi_logistic" t a -> TensorApply t
__npi_logistic args
  = let scalarArgs
          = catMaybes
              [("loc",) . showValue <$> (args !? #loc :: Maybe (Maybe Float)),
        ...
        tensorKeyArgs
          = catMaybes
              [("input1",) <$> (args !? #input1 :: Maybe t),
               ("input2",) <$> (args !? #input2 :: Maybe t)]
      in
      apply "_npi_logistic" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_matmul" t =
     '[ '("a", AttrOpt t), '("b", AttrOpt t)]

__npi_matmul ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_matmul" t a, HasCallStack) =>
               ArgsHMap "__npi_matmul" t a -> TensorApply t
__npi_matmul args
  = let scalarArgs = catMaybes []
        tensorKeyArgs
          = catMaybes
...
type instance ParameterList "__npi_nan_to_num" t =
     '[ '("copy", AttrOpt Bool), '("nan", AttrOpt Double),
        '("posinf", AttrOpt (Maybe Double)),
        '("neginf", AttrOpt (Maybe Double)), '("data", AttrOpt t)]

__npi_nan_to_num ::
                 forall a t .
                   (TensorOp t t, Fullfilled "__npi_nan_to_num" t a, HasCallStack) =>
                   ArgsHMap "__npi_nan_to_num" t a -> TensorApply t
__npi_nan_to_num args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_npi_nan_to_num" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_norm" t =
     '[ '("data", AttrOpt t)]

__npi_norm ::
           forall a t .
             (TensorOp t t, Fullfilled "__npi_norm" t a, HasCallStack) =>
             ArgsHMap "__npi_norm" t a -> TensorApply t
__npi_norm args
  = let scalarArgs = catMaybes []
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in
      apply "_npi_norm" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_normal_n" t =
     '[ '("loc", AttrReq (Maybe Float)),
        '("scale", AttrReq (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text),
        '("dtype", AttrOpt (EnumType '["float16", "float32", "float64"])),
...
__npi_normal_n ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_normal_n" t a, HasCallStack) =>
                 ArgsHMap "__npi_normal_n" t a -> TensorApply t
__npi_normal_n args
  = let scalarArgs
          = catMaybes
              [("loc",) . showValue <$> (args !? #loc :: Maybe (Maybe Float)),
        ...
        tensorKeyArgs
          = catMaybes
              [("input1",) <$> (args !? #input1 :: Maybe t),
               ("input2",) <$> (args !? #input2 :: Maybe t)]
      in
      apply "_npi_normal_n" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_pareto" t =
     '[ '("a", AttrOpt (Maybe Float)), '("size", AttrOpt (Maybe [Int])),
        '("ctx", AttrOpt Text), '("input1", AttrOpt t)]

__npi_pareto ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_pareto" t a, HasCallStack) =>
               ArgsHMap "__npi_pareto" t a -> TensorApply t
__npi_pareto args
  = let scalarArgs
          = catMaybes
              [("a",) . showValue <$> (args !? #a :: Maybe (Maybe Float)),
        ...
        tensorKeyArgs
          = catMaybes [("input1",) <$> (args !? #input1 :: Maybe t)]
      in
      apply "_npi_pareto" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_percentile" t =
     '[ '("axis", AttrOpt (Maybe [Int])),
        '("interpolation",
          AttrOpt
            (EnumType '["higher", "linear", "lower", "midpoint", "nearest"])),
        '("keepdims", AttrOpt Bool), '("q_scalar", AttrOpt (Maybe Double)),
        '("a", AttrOpt t), '("q", AttrOpt t)]

__npi_percentile ::
                 forall a t .
                   (TensorOp t t, Fullfilled "__npi_percentile" t a, HasCallStack) =>
                   ArgsHMap "__npi_percentile" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("a",) <$> (args !? #a :: Maybe t),
               ("q",) <$> (args !? #q :: Maybe t)]
      in
      apply "_npi_percentile" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_pinv" t =
     '[ '("hermitian", AttrOpt Bool), '("a", AttrOpt t),
        '("rcond", AttrOpt t)]

__npi_pinv ::
           forall a t .
             (TensorOp t t, Fullfilled "__npi_pinv" t a, HasCallStack) =>
             ArgsHMap "__npi_pinv" t a -> TensorApply t
__npi_pinv args
  = let scalarArgs
          = catMaybes
        ...
        tensorKeyArgs
          = catMaybes
              [("a",) <$> (args !? #a :: Maybe t),
               ("rcond",) <$> (args !? #rcond :: Maybe t)]
      in
      apply "_npi_pinv" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_pinv_scalar_rcond" t =
     '[ '("rcond", AttrOpt Double), '("hermitian", AttrOpt Bool),
        '("a", AttrOpt t)]

__npi_pinv_scalar_rcond ::
                        forall a t .
                          (TensorOp t t, Fullfilled "__npi_pinv_scalar_rcond" t a,
                           HasCallStack) =>
                          ArgsHMap "__npi_pinv_scalar_rcond" t a -> TensorApply t
__npi_pinv_scalar_rcond args
  = let scalarArgs
        ...
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_pinv_scalar_rcond" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_polyval" t =
     '[ '("p", AttrOpt t), '("x", AttrOpt t)]

__npi_polyval ::
              forall a t .
                (TensorOp t t, Fullfilled "__npi_polyval" t a, HasCallStack) =>
                ArgsHMap "__npi_polyval" t a -> TensorApply t
__npi_polyval args
  = let scalarArgs = catMaybes []
        tensorKeyArgs
          = catMaybes
...
type instance ParameterList "__npi_powerd" t =
     '[ '("a", AttrOpt (Maybe Float)), '("size", AttrOpt (Maybe [Int])),
        '("input1", AttrOpt t)]

__npi_powerd ::
             forall a t .
               (TensorOp t t, Fullfilled "__npi_powerd" t a, HasCallStack) =>
               ArgsHMap "__npi_powerd" t a -> TensorApply t
__npi_powerd args
  = let scalarArgs
          = catMaybes
              [("a",) . showValue <$> (args !? #a :: Maybe (Maybe Float)),
...
type instance ParameterList "__npi_rayleigh" t =
     '[ '("scale", AttrOpt (Maybe Float)),
        '("size", AttrOpt (Maybe [Int])), '("ctx", AttrOpt Text),
        '("input1", AttrOpt t)]
...
__npi_rayleigh ::
               forall a t .
                 (TensorOp t t, Fullfilled "__npi_rayleigh" t a, HasCallStack) =>
                 ArgsHMap "__npi_rayleigh" t a -> TensorApply t
__npi_rayleigh args
  = let scalarArgs
          = catMaybes
              [("scale",) . showValue <$>
        ...
        tensorKeyArgs
          = catMaybes [("input1",) <$> (args !? #input1 :: Maybe t)]
      in
      apply "_npi_rayleigh" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_solve" t =
     '[ '("a", AttrOpt t), '("b", AttrOpt t)]

__npi_solve ::
            forall a t .
              (TensorOp t t, Fullfilled "__npi_solve" t a, HasCallStack) =>
              ArgsHMap "__npi_solve" t a -> TensorApply t
__npi_solve args
  = let scalarArgs = catMaybes []
        tensorKeyArgs
          = catMaybes
              [("a",) <$> (args !? #a :: Maybe t),
               ("b",) <$> (args !? #b :: Maybe t)]
      in
      apply "_npi_solve" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_tensorinv" t =
     '[ '("ind", AttrOpt Int), '("a", AttrOpt t)]

__npi_tensorinv ::
                forall a t .
                  (TensorOp t t, Fullfilled "__npi_tensorinv" t a, HasCallStack) =>
                  ArgsHMap "__npi_tensorinv" t a -> TensorApply t
__npi_tensorinv args
  = let scalarArgs
          = catMaybes [("ind",) . showValue <$> (args !? #ind :: Maybe Int)]
        tensorKeyArgs = catMaybes [("a",) <$> (args !? #a :: Maybe t)]
      in
      apply "_npi_tensorinv" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_tensorsolve" t =
     '[ '("a_axes", AttrOpt [Int]), '("a", AttrOpt t),
        '("b", AttrOpt t)]

__npi_tensorsolve ::
                  forall a t .
                    (TensorOp t t, Fullfilled "__npi_tensorsolve" t a, HasCallStack) =>
                    ArgsHMap "__npi_tensorsolve" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("a",) <$> (args !? #a :: Maybe t),
               ("b",) <$> (args !? #b :: Maybe t)]
      in
      apply "_npi_tensorsolve" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_uniform_n" t =
     '[ '("low", AttrReq (Maybe Float)),
        '("high", AttrReq (Maybe Float)), '("size", AttrOpt (Maybe [Int])),
        '("ctx", AttrOpt Text),
        '("dtype", AttrOpt (EnumType '["float16", "float32", "float64"])),
...
__npi_uniform_n ::
                forall a t .
                  (TensorOp t t, Fullfilled "__npi_uniform_n" t a, HasCallStack) =>
                  ArgsHMap "__npi_uniform_n" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("input1",) <$> (args !? #input1 :: Maybe t),
               ("input2",) <$> (args !? #input2 :: Maybe t)]
      in
      apply "_npi_uniform_n" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npi_weibull" t =
     '[ '("a", AttrOpt (Maybe Float)), '("size", AttrOpt (Maybe [Int])),
        '("ctx", AttrOpt Text), '("input1", AttrOpt t)]

__npi_weibull ::
              forall a t .
                (TensorOp t t, Fullfilled "__npi_weibull" t a, HasCallStack) =>
                ArgsHMap "__npi_weibull" t a -> TensorApply t
__npi_weibull args
  = let scalarArgs
          = catMaybes
              [("a",) . showValue <$> (args !? #a :: Maybe (Maybe Float)),
        ...
        tensorKeyArgs
          = catMaybes [("input1",) <$> (args !? #input1 :: Maybe t)]
      in
      apply "_npi_weibull" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_where" t =
     '[ '("condition", AttrOpt t), '("x", AttrOpt t), '("y", AttrOpt t)]

__npi_where ::
            forall a t .
              (TensorOp t t, Fullfilled "__npi_where" t a, HasCallStack) =>
              ArgsHMap "__npi_where" t a -> TensorApply t
__npi_where args
  = let scalarArgs = catMaybes []
        tensorKeyArgs
          = catMaybes
              [("condition",) <$> (args !? #condition :: Maybe t),
               ...
               ("y",) <$> (args !? #y :: Maybe t)]
      in
      apply "_npi_where" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_where_lscalar" t =
     '[ '("scalar", AttrOpt Double), '("condition", AttrOpt t),
        '("x", AttrOpt t)]

__npi_where_lscalar ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__npi_where_lscalar" t a,
                       HasCallStack) =>
                      ArgsHMap "__npi_where_lscalar" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("condition",) <$> (args !? #condition :: Maybe t),
               ("x",) <$> (args !? #x :: Maybe t)]
      in
      apply "_npi_where_lscalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_where_rscalar" t =
     '[ '("scalar", AttrOpt Double), '("condition", AttrOpt t),
        '("y", AttrOpt t)]

__npi_where_rscalar ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__npi_where_rscalar" t a,
                       HasCallStack) =>
                      ArgsHMap "__npi_where_rscalar" t a -> TensorApply t
        ...
        tensorKeyArgs
          = catMaybes
              [("condition",) <$> (args !? #condition :: Maybe t),
               ("y",) <$> (args !? #y :: Maybe t)]
      in
      apply "_npi_where_rscalar" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))

type instance ParameterList "__npi_where_scalar2" t =
     '[ '("x", AttrOpt Double), '("y", AttrOpt Double),
        '("condition", AttrOpt t)]

__npi_where_scalar2 ::
                    forall a t .
                      (TensorOp t t, Fullfilled "__npi_where_scalar2" t a,
                       HasCallStack) =>
                      ArgsHMap "__npi_where_scalar2" t a -> TensorApply t
__npi_where_scalar2 args
  = let scalarArgs
        ...
        tensorKeyArgs
          = catMaybes [("condition",) <$> (args !? #condition :: Maybe t)]
      in
      apply "_npi_where_scalar2" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "__npx_constraint_check" t =
     '[ '("msg", AttrOpt Text), '("input", AttrOpt t)]

__npx_constraint_check ::
                       forall a t .
                         (TensorOp t t, Fullfilled "__npx_constraint_check" t a,
                          HasCallStack) =>
                         ArgsHMap "__npx_constraint_check" t a -> TensorApply t
__npx_constraint_check args
  = let scalarArgs
          = catMaybes [("msg",) . showValue <$> (args !? #msg :: Maybe Text)]
        tensorKeyArgs
          = catMaybes [("input",) <$> (args !? #input :: Maybe t)]
      in
      apply "_npx_constraint_check" scalarArgs
        (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "_col2im" t =
     '[ '("output_size", AttrReq [Int]), '("kernel", AttrReq [Int]),
        '("stride", AttrOpt [Int]), '("dilate", AttrOpt [Int]),
        '("pad", AttrOpt [Int]), '("data", AttrOpt t)]

_col2im ::
        forall a t .
          (TensorOp t t, Fullfilled "_col2im" t a, HasCallStack) =>
          ArgsHMap "_col2im" t a -> TensorApply t
_col2im args
  = let scalarArgs
          = catMaybes
              [("output_size",) . showValue <$>
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in apply "col2im" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))
...
type instance ParameterList "_im2col" t =
     '[ '("kernel", AttrReq [Int]), '("stride", AttrOpt [Int]),
        '("dilate", AttrOpt [Int]), '("pad", AttrOpt [Int]),
        '("data", AttrOpt t)]
...
_im2col ::
        forall a t .
          (TensorOp t t, Fullfilled "_im2col" t a, HasCallStack) =>
          ArgsHMap "_im2col" t a -> TensorApply t
_im2col args
  = let scalarArgs
          = catMaybes
              [("kernel",) . showValue <$> (args !? #kernel :: Maybe [Int]),
        ...
        tensorKeyArgs
          = catMaybes [("data",) <$> (args !? #data :: Maybe t)]
      in apply "im2col" scalarArgs (Left (tensorKeyArgs :: [(Text, t)]))
