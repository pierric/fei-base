...
type instance ParameterList "_GroupNorm(symbol)" =
...
type instance ParameterList "_FusedOp(symbol)" =
     '[ '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "_FusedOpHelper(symbol)" = '[]
...
type instance ParameterList "_FusedOpOutHelper(symbol)" = '[]
...
type instance ParameterList "_backward_GroupNorm(symbol)" = '[]
...
type instance ParameterList "_backward_RROIAlign(symbol)" = '[]
...
type instance
     ParameterList "_backward_backward_FullyConnected(symbol)" = '[]
...
type instance
     ParameterList "_backward_interleaved_matmul_encdec_qk(symbol)" =
     '[]
                                       ...
                                       forall args .
                                         ...
                                         String ->
                                           ArgsHMap "_backward_interleaved_matmul_encdec_qk(symbol)"
                                             args
                                             -> IO SymbolHandle
_backward_interleaved_matmul_encdec_qk name args
  = let scalarArgs = catMaybes []
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs = catMaybes []
        (tensorkeys, tensorvals) = unzip tensorArgs
...
type instance
     ParameterList "_backward_interleaved_matmul_encdec_valatt(symbol)"
     = '[]
                                           ...
                                           forall args .
                                             ...
                                             String ->
                                               ArgsHMap
                                                 ...
                                                 args
                                                 -> IO SymbolHandle
_backward_interleaved_matmul_encdec_valatt name args
  = let scalarArgs = catMaybes []
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs = catMaybes []
        (tensorkeys, tensorvals) = unzip tensorArgs
...
type instance
     ParameterList "_backward_interleaved_matmul_selfatt_qk(symbol)" =
     '[]
                                        ...
                                        forall args .
                                          ...
                                          String ->
                                            ArgsHMap
                                              ...
                                              args
                                              -> IO SymbolHandle
_backward_interleaved_matmul_selfatt_qk name args
  = let scalarArgs = catMaybes []
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs = catMaybes []
        (tensorkeys, tensorvals) = unzip tensorArgs
...
type instance
     ParameterList "_backward_interleaved_matmul_selfatt_valatt(symbol)"
     = '[]
                                            ...
                                            forall args .
                                              ...
                                              String ->
                                                ArgsHMap
                                                  ...
                                                  args
                                                  -> IO SymbolHandle
_backward_interleaved_matmul_selfatt_valatt name args
  = let scalarArgs = catMaybes []
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs = catMaybes []
        (tensorkeys, tensorvals) = unzip tensorArgs
...
type instance ParameterList "_backward_linalg_det(symbol)" = '[]
...
type instance ParameterList "_backward_linalg_slogdet(symbol)" =
     '[]
...
type instance ParameterList "_backward_np_broadcast_to(symbol)" =
     '[]
...
type instance ParameterList "_backward_np_column_stack(symbol)" =
     '[]
...
type instance ParameterList "_backward_np_concat(symbol)" = '[]
...
type instance ParameterList "_backward_np_cumsum(symbol)" = '[]
...
type instance ParameterList "_backward_np_dot(symbol)" = '[]
...
type instance ParameterList "_backward_np_dstack(symbol)" = '[]
...
type instance ParameterList "_backward_np_max(symbol)" = '[]
...
type instance ParameterList "_backward_np_mean(symbol)" = '[]
...
type instance ParameterList "_backward_np_min(symbol)" = '[]
...
type instance ParameterList "_backward_np_prod(symbol)" = '[]
...
type instance ParameterList "_backward_np_sum(symbol)" = '[]
...
type instance ParameterList "_backward_np_trace(symbol)" = '[]
...
type instance ParameterList "_backward_np_vstack(symbol)" = '[]
...
type instance ParameterList "_backward_npi_arctan2(symbol)" = '[]
...
type instance ParameterList "_backward_npi_arctan2_scalar(symbol)"
     =
     '[ '("scalar", AttrOpt Float), '("lhs", AttrOpt SymbolHandle),
        '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_backward_npi_broadcast_mul(symbol)" =
     '[]
...
type instance ParameterList "_backward_npi_copysign(symbol)" = '[]
...
type instance ParameterList "_backward_npi_copysign_scalar(symbol)"
     = '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_backward_npi_diff(symbol)" = '[]
...
type instance ParameterList "_backward_npi_einsum(symbol)" = '[]
...
type instance ParameterList "_backward_npi_flip(symbol)" = '[]
...
type instance ParameterList "_backward_npi_hypot(symbol)" = '[]
...
type instance ParameterList "_backward_npi_ldexp(symbol)" = '[]
...
type instance ParameterList "_backward_npi_ldexp_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("lhs", AttrOpt SymbolHandle),
        '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_backward_npi_rarctan2_scalar(symbol)"
     =
     '[ '("scalar", AttrOpt Float), '("lhs", AttrOpt SymbolHandle),
        '("rhs", AttrOpt SymbolHandle)]
...
type instance
     ParameterList "_backward_npi_rcopysign_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_backward_npi_rldexp_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("lhs", AttrOpt SymbolHandle),
        '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_backward_npi_svd(symbol)" = '[]
...
type instance ParameterList "_backward_npi_tensordot(symbol)" = '[]
...
type instance
     ParameterList "_backward_npi_tensordot_int_axes(symbol)" = '[]
...
type instance ParameterList "_backward_pdf_dirichlet(symbol)" = '[]
...
type instance ParameterList "_backward_pdf_exponential(symbol)" =
     '[]
...
type instance ParameterList "_backward_pdf_gamma(symbol)" = '[]
...
type instance
     ParameterList "_backward_pdf_generalized_negative_binomial(symbol)"
     = '[]
                                            ...
                                            forall args .
                                              ...
                                              String ->
                                                ArgsHMap
                                                  ...
                                                  args
                                                  -> IO SymbolHandle
_backward_pdf_generalized_negative_binomial name args
  = let scalarArgs = catMaybes []
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs = catMaybes []
        (tensorkeys, tensorvals) = unzip tensorArgs
...
type instance
     ParameterList "_backward_pdf_negative_binomial(symbol)" = '[]
...
type instance ParameterList "_backward_pdf_normal(symbol)" = '[]
...
type instance ParameterList "_backward_pdf_poisson(symbol)" = '[]
...
type instance ParameterList "_backward_pdf_uniform(symbol)" = '[]
...
type instance ParameterList "_backward_tril(symbol)" = '[]
...
type instance ParameterList "_contrib_RROIAlign(symbol)" =
     '[ '("pooled_size", AttrReq [Int]),
        '("spatial_scale", AttrReq Float),
        '("sampling_ratio", AttrOpt Int), '("data", AttrOpt SymbolHandle),
        '("rois", AttrOpt SymbolHandle)]
...
type instance ParameterList "_contrib_allclose(symbol)" =
     '[ '("rtol", AttrOpt Float), '("atol", AttrOpt Float),
        '("equal_nan", AttrOpt Bool), '("a", AttrOpt SymbolHandle),
        '("b", AttrOpt SymbolHandle)]
...
type instance ParameterList "_contrib_box_decode(symbol)" =
     '[ '("std0", AttrOpt Float), '("std1", AttrOpt Float),
        '("std2", AttrOpt Float), '("std3", AttrOpt Float),
        '("clip", AttrOpt Float),
        '("format", AttrOpt (EnumType '["center", "corner"])),
        '("data", AttrOpt SymbolHandle),
        '("anchors", AttrOpt SymbolHandle)]
...
_contrib_box_decode name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe SymbolHandle),
               ("anchors",) <$> (args !? #anchors :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_contrib_box_encode(symbol)" =
     '[ '("samples", AttrOpt SymbolHandle),
        '("matches", AttrOpt SymbolHandle),
        '("anchors", AttrOpt SymbolHandle),
        '("refs", AttrOpt SymbolHandle), '("means", AttrOpt SymbolHandle),
        '("stds", AttrOpt SymbolHandle)]
...
_contrib_box_encode name args
  = let scalarArgs = catMaybes []
        ...
        tensorArgs
          = catMaybes
              [("samples",) <$> (args !? #samples :: Maybe SymbolHandle),
               ("matches",) <$> (args !? #matches :: Maybe SymbolHandle),
               ("anchors",) <$> (args !? #anchors :: Maybe SymbolHandle),
               ("refs",) <$> (args !? #refs :: Maybe SymbolHandle),
               ("means",) <$> (args !? #means :: Maybe SymbolHandle),
               ("stds",) <$> (args !? #stds :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_contrib_calibrate_entropy(symbol)" =
     '[ '("num_quantized_bins", AttrOpt Int),
        '("hist", AttrOpt SymbolHandle),
        '("hist_edges", AttrOpt SymbolHandle)]
...
_contrib_calibrate_entropy name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("hist",) <$> (args !? #hist :: Maybe SymbolHandle),
               ("hist_edges",) <$> (args !? #hist_edges :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance
     ParameterList "_contrib_interleaved_matmul_encdec_qk(symbol)" =
     '[ '("heads", AttrReq Int), '("queries", AttrOpt SymbolHandle),
        '("keys_values", AttrOpt SymbolHandle)]
                                      ...
                                      forall args .
                                        ...
                                        String ->
                                          ArgsHMap "_contrib_interleaved_matmul_encdec_qk(symbol)"
                                            args
                                            -> IO SymbolHandle
_contrib_interleaved_matmul_encdec_qk name args
  = let scalarArgs
          = catMaybes
        ...
        tensorArgs
          = catMaybes
              [("queries",) <$> (args !? #queries :: Maybe SymbolHandle),
               ("keys_values",) <$> (args !? #keys_values :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance
     ParameterList "_contrib_interleaved_matmul_encdec_valatt(symbol)" =
     '[ '("heads", AttrReq Int), '("keys_values", AttrOpt SymbolHandle),
        '("attention", AttrOpt SymbolHandle)]
                                          ...
                                          forall args .
                                            ...
                                            String ->
                                              ArgsHMap
                                                ...
                                                args
                                                -> IO SymbolHandle
_contrib_interleaved_matmul_encdec_valatt name args
  = let scalarArgs
          = catMaybes
              [("heads",) . showValue <$> (args !? #heads :: Maybe Int)]
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs
          = catMaybes
              [("keys_values",) <$> (args !? #keys_values :: Maybe SymbolHandle),
               ("attention",) <$> (args !? #attention :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance
     ParameterList "_contrib_interleaved_matmul_selfatt_qk(symbol)" =
     '[ '("heads", AttrReq Int),
        '("queries_keys_values", AttrOpt SymbolHandle)]
                                       ...
                                       forall args .
                                         ...
                                         String ->
                                           ArgsHMap "_contrib_interleaved_matmul_selfatt_qk(symbol)"
                                             args
                                             -> IO SymbolHandle
_contrib_interleaved_matmul_selfatt_qk name args
  = let scalarArgs
          = catMaybes
              [("heads",) . showValue <$> (args !? #heads :: Maybe Int)]
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs
          = catMaybes
              [("queries_keys_values",) <$>
                 (args !? #queries_keys_values :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance
     ParameterList "_contrib_interleaved_matmul_selfatt_valatt(symbol)"
     =
     '[ '("heads", AttrReq Int),
        '("queries_keys_values", AttrOpt SymbolHandle),
        '("attention", AttrOpt SymbolHandle)]
                                           ...
                                           forall args .
                                             ...
                                             String ->
                                               ArgsHMap
                                                 ...
                                                 args
                                                 -> IO SymbolHandle
_contrib_interleaved_matmul_selfatt_valatt name args
  = let scalarArgs
          = catMaybes
              [("heads",) . showValue <$> (args !? #heads :: Maybe Int)]
        (scalarkeys, scalarvals) = unzip scalarArgs
...
type instance ParameterList "_contrib_mrcnn_mask_target(symbol)" =
     '[ '("num_rois", AttrReq Int), '("num_classes", AttrReq Int),
        '("mask_size", AttrReq [Int]), '("sample_ratio", AttrOpt Int),
        '("rois", AttrOpt SymbolHandle),
        '("gt_masks", AttrOpt SymbolHandle),
        '("matches", AttrOpt SymbolHandle),
        '("cls_targets", AttrOpt SymbolHandle)]
...
_contrib_mrcnn_mask_target name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("rois",) <$> (args !? #rois :: Maybe SymbolHandle),
               ("gt_masks",) <$> (args !? #gt_masks :: Maybe SymbolHandle),
               ("matches",) <$> (args !? #matches :: Maybe SymbolHandle),
               ("cls_targets",) <$> (args !? #cls_targets :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_contrib_quantized_batch_norm(symbol)"
     =
     '[ '("eps", AttrOpt Double), '("momentum", AttrOpt Float),
        '("fix_gamma", AttrOpt Bool), '("use_global_stats", AttrOpt Bool),
        '("output_mean_var", AttrOpt Bool), '("axis", AttrOpt Int),
...
type instance ParameterList "_contrib_round_ste(symbol)" =
     '[ '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_contrib_sign_ste(symbol)" =
     '[ '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_linalg_det(symbol)" =
...
type instance ParameterList "_linalg_slogdet(symbol)" =
     '[ '("_A", AttrOpt SymbolHandle)]
...
type instance ParameterList "_multi_adamw_update(symbol)" =
...
type instance ParameterList "_multi_mp_adamw_update(symbol)" =
     '[ '("lrs", AttrReq [Float]), '("beta1", AttrOpt Float),
        '("beta2", AttrOpt Float), '("epsilon", AttrOpt Float),
        '("wds", AttrReq [Float]), '("etas", AttrReq [Float]),
        '("clip_gradient", AttrOpt Float), '("num_weights", AttrOpt Int),
...
type instance ParameterList "_np_broadcast_to(symbol)" =
     '[ '("shape", AttrOpt [Int]), '("array", AttrOpt SymbolHandle)]
...
_np_broadcast_to name args
  = let scalarArgs
        ...
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs
          = catMaybes [("array",) <$> (args !? #array :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_np_copy(symbol)" =
...
type instance ParameterList "_np_cumsum(symbol)" =
...
type instance ParameterList "_np_dot(symbol)" =
     '[ '("a", AttrOpt SymbolHandle), '("b", AttrOpt SymbolHandle)]
...
type instance ParameterList "_np_max(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])), '("keepdims", AttrOpt Bool),
        '("initial", AttrOpt (Maybe Double)), '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_np_min(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])), '("keepdims", AttrOpt Bool),
        '("initial", AttrOpt (Maybe Double)), '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_np_moveaxis(symbol)" =
...
type instance ParameterList "_np_ones_like(symbol)" =
     '[ '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_np_prod(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])),
        '("dtype",
          AttrOpt
            (Maybe
...
type instance ParameterList "_np_roll(symbol)" =
...
type instance ParameterList "_np_squeeze(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])), '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_np_sum(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])),
        '("dtype",
          AttrOpt
            (Maybe
...
type instance ParameterList "_np_trace(symbol)" =
...
type instance ParameterList "_np_transpose(symbol)" =
     '[ '("axes", AttrOpt [Int]), '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_np_zeros_like(symbol)" =
     '[ '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_absolute(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
_npi_absolute name args
  = let scalarArgs = catMaybes []
        (scalarkeys, scalarvals) = unzip scalarArgs
        tensorArgs
          = catMaybes [("x",) <$> (args !? #x :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_npi_add(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_add_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arccos(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arccosh(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arcsin(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arcsinh(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arctan(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arctan2(symbol)" =
     '[ '("x1", AttrOpt SymbolHandle), '("x2", AttrOpt SymbolHandle)]
...
_npi_arctan2 name args
  = let scalarArgs = catMaybes []
        ...
        tensorArgs
          = catMaybes
              [("x1",) <$> (args !? #x1 :: Maybe SymbolHandle),
               ("x2",) <$> (args !? #x2 :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_npi_arctan2_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_arctanh(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_argmax(symbol)" =
     '[ '("axis", AttrOpt (Maybe Int)), '("keepdims", AttrOpt Bool),
        '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_argmin(symbol)" =
     '[ '("axis", AttrOpt (Maybe Int)), '("keepdims", AttrOpt Bool),
        '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_around(symbol)" =
     '[ '("decimals", AttrOpt Int), '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_bitwise_xor(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_bitwise_xor_scalar(symbol)" =
     '[ '("scalar", AttrOpt Int), '("data", AttrOpt SymbolHandle)]
...
type instance
     ParameterList "_npi_boolean_mask_assign_scalar(symbol)" =
     '[ '("value", AttrOpt Float), '("data", AttrOpt SymbolHandle),
        '("mask", AttrOpt SymbolHandle)]
...
_npi_boolean_mask_assign_scalar name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe SymbolHandle),
               ("mask",) <$> (args !? #mask :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance
     ParameterList "_npi_boolean_mask_assign_tensor(symbol)" =
     '[ '("data", AttrOpt SymbolHandle),
        '("mask", AttrOpt SymbolHandle), '("value", AttrOpt SymbolHandle)]
  ...
  = let scalarArgs = catMaybes []
        ...
        tensorArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe SymbolHandle),
               ("mask",) <$> (args !? #mask :: Maybe SymbolHandle),
               ("value",) <$> (args !? #value :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_npi_cbrt(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_ceil(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
_npi_choice name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("input1",) <$> (args !? #input1 :: Maybe SymbolHandle),
               ("input2",) <$> (args !? #input2 :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_npi_column_stack(symbol)" =
     '[ '("num_args", AttrReq Int), '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "_npi_concatenate(symbol)" =
     '[ '("num_args", AttrReq Int), '("dim", AttrOpt Int),
        '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "_npi_copysign(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_copysign_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_cos(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_cosh(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_degrees(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_diff(symbol)" =
...
type instance ParameterList "_npi_dstack(symbol)" =
     '[ '("num_args", AttrReq Int), '("dim", AttrOpt Int),
        '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "_npi_equal(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_equal_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_exp(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_expm1(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_fix(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_flip(symbol)" =
...
type instance ParameterList "_npi_floor(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_greater(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_greater_equal(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_greater_equal_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_greater_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_hsplit(symbol)" =
...
type instance ParameterList "_npi_hsplit_backward(symbol)" = '[]
...
type instance ParameterList "_npi_hypot(symbol)" =
     '[ '("x1", AttrOpt SymbolHandle), '("x2", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_indices(symbol)" =
...
type instance ParameterList "_npi_lcm(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_lcm_scalar(symbol)" =
     '[ '("scalar", AttrOpt Int), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_ldexp(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_ldexp_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_less(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_less_equal(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_less_equal_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_less_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_log(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_log10(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_log1p(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_log2(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_logical_not(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_mean(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])),
        '("dtype",
          AttrOpt
            (Maybe
...
type instance ParameterList "_npi_mod(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_mod_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_multinomial(symbol)" =
     '[ '("n", AttrReq Int), '("pvals", AttrOpt Int),
        '("size", AttrOpt (Maybe [Int])), '("a", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_multiply(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_multiply_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_negative(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_not_equal(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_not_equal_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_power(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_power_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_radians(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rarctan2_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rcopysign_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_reciprocal(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rint(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rldexp_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rmod_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rot90(symbol)" =
...
type instance ParameterList "_npi_rpower_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rsubtract_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_rtrue_divide_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_share_memory(symbol)" =
     '[ '("a", AttrOpt SymbolHandle), '("b", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_sign(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_sin(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_sinh(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_sqrt(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_square(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_stack(symbol)" =
...
type instance ParameterList "_npi_std(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])),
        '("dtype",
          AttrOpt
            (Maybe
...
type instance ParameterList "_npi_subtract(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_subtract_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_svd(symbol)" =
     '[ '("_A", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_tan(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_tanh(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_tensordot(symbol)" =
     '[ '("a_axes_summed", AttrReq [Int]),
        '("b_axes_summed", AttrReq [Int]), '("a", AttrOpt SymbolHandle),
        '("b", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_tensordot_int_axes(symbol)" =
     '[ '("axes", AttrReq Int), '("a", AttrOpt SymbolHandle),
        '("b", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_tril(symbol)" =
     '[ '("k", AttrOpt Int), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_true_divide(symbol)" =
     '[ '("lhs", AttrOpt SymbolHandle), '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_true_divide_scalar(symbol)" =
     '[ '("scalar", AttrOpt Float), '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_trunc(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npi_unique(symbol)" =
...
type instance ParameterList "_npi_var(symbol)" =
     '[ '("axis", AttrOpt (Maybe [Int])),
        '("dtype",
          AttrOpt
            (Maybe
...
type instance ParameterList "_npi_vstack(symbol)" =
     '[ '("num_args", AttrReq Int), '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "_npx_nonzero(symbol)" =
     '[ '("x", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npx_relu(symbol)" =
     '[ '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_npx_sigmoid(symbol)" =
     '[ '("data", AttrOpt SymbolHandle)]
...
type instance ParameterList "_random_pdf_dirichlet(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
        '("alpha", AttrOpt SymbolHandle)]
...
_random_pdf_dirichlet name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("sample",) <$> (args !? #sample :: Maybe SymbolHandle),
               ("alpha",) <$> (args !? #alpha :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_random_pdf_exponential(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
...
_random_pdf_exponential name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("sample",) <$> (args !? #sample :: Maybe SymbolHandle),
               ("lam",) <$> (args !? #lam :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "_random_pdf_gamma(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
        '("alpha", AttrOpt SymbolHandle), '("beta", AttrOpt SymbolHandle)]
...
type instance
     ParameterList "_random_pdf_generalized_negative_binomial(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
                                          ...
                                          forall args .
                                            ...
                                            String ->
                                              ArgsHMap
                                                ...
                                                args
                                                -> IO SymbolHandle
_random_pdf_generalized_negative_binomial name args
  = let scalarArgs
          = catMaybes
              [("is_log",) . showValue <$> (args !? #is_log :: Maybe Bool)]
        (scalarkeys, scalarvals) = unzip scalarArgs
...
type instance ParameterList "_random_pdf_negative_binomial(symbol)"
     =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
...
type instance ParameterList "_random_pdf_normal(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
...
type instance ParameterList "_random_pdf_poisson(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
        '("lam", AttrOpt SymbolHandle)]
...
type instance ParameterList "_random_pdf_uniform(symbol)" =
     '[ '("is_log", AttrOpt Bool), '("sample", AttrOpt SymbolHandle),
...
type instance ParameterList "_sg_mkldnn_conv(symbol)" = '[]
...
type instance ParameterList "_sg_mkldnn_fully_connected(symbol)" =
     '[]
...
type instance ParameterList "lamb_update_phase1(symbol)" =
...
type instance ParameterList "lamb_update_phase2(symbol)" =
     '[ '("lr", AttrReq Float), '("lower_bound", AttrOpt Float),
        '("upper_bound", AttrOpt Float), '("weight", AttrOpt SymbolHandle),
        '("g", AttrOpt SymbolHandle), '("r1", AttrOpt SymbolHandle),
        '("r2", AttrOpt SymbolHandle)]
        ...
        tensorArgs
          = catMaybes
              [("weight",) <$> (args !? #weight :: Maybe SymbolHandle),
               ...
               ("r1",) <$> (args !? #r1 :: Maybe SymbolHandle),
               ("r2",) <$> (args !? #r2 :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "mp_lamb_update_phase1(symbol)" =
     '[ '("beta1", AttrOpt Float), '("beta2", AttrOpt Float),
        '("epsilon", AttrOpt Float), '("t", AttrReq Int),
        '("bias_correction", AttrOpt Bool), '("wd", AttrReq Float),
        '("rescale_grad", AttrOpt Float),
...
type instance ParameterList "mp_lamb_update_phase2(symbol)" =
     '[ '("lr", AttrReq Float), '("lower_bound", AttrOpt Float),
        '("upper_bound", AttrOpt Float), '("weight", AttrOpt SymbolHandle),
        '("g", AttrOpt SymbolHandle), '("r1", AttrOpt SymbolHandle),
        '("r2", AttrOpt SymbolHandle), '("weight32", AttrOpt SymbolHandle)]
...
type instance ParameterList "multi_lars(symbol)" =
     '[ '("eta", AttrReq Float), '("eps", AttrReq Float),
        '("rescale_grad", AttrOpt Float), '("lrs", AttrOpt SymbolHandle),
        '("weights_sum_sq", AttrOpt SymbolHandle),
        '("grads_sum_sq", AttrOpt SymbolHandle),
        '("wds", AttrOpt SymbolHandle)]
...
multi_lars name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("lrs",) <$> (args !? #lrs :: Maybe SymbolHandle),
               ("weights_sum_sq",) <$>
                 (args !? #weights_sum_sq :: Maybe SymbolHandle),
               ("grads_sum_sq",) <$>
                 (args !? #grads_sum_sq :: Maybe SymbolHandle),
               ("wds",) <$> (args !? #wds :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
...
type instance ParameterList "multi_sum_sq(symbol)" =
     '[ '("num_arrays", AttrReq Int), '("data", AttrOpt [SymbolHandle])]
...
type instance
     ParameterList "preloaded_multi_mp_sgd_mom_update(symbol)" =
     '[ '("momentum", AttrOpt Float), '("rescale_grad", AttrOpt Float),
        '("clip_gradient", AttrOpt Float), '("num_weights", AttrOpt Int),
        '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "preloaded_multi_mp_sgd_update(symbol)"
     =
     '[ '("rescale_grad", AttrOpt Float),
        '("clip_gradient", AttrOpt Float), '("num_weights", AttrOpt Int),
        '("data", AttrOpt [SymbolHandle])]
...
type instance
     ParameterList "preloaded_multi_sgd_mom_update(symbol)" =
     '[ '("momentum", AttrOpt Float), '("rescale_grad", AttrOpt Float),
        '("clip_gradient", AttrOpt Float), '("num_weights", AttrOpt Int),
        '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "preloaded_multi_sgd_update(symbol)" =
     '[ '("rescale_grad", AttrOpt Float),
        '("clip_gradient", AttrOpt Float), '("num_weights", AttrOpt Int),
        '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "reset_arrays(symbol)" =
     '[ '("num_arrays", AttrReq Int), '("data", AttrOpt [SymbolHandle])]
...
type instance ParameterList "reshape_like(symbol)" =
     '[ '("lhs_begin", AttrOpt (Maybe Int)),
        ...
        '("rhs_end", AttrOpt (Maybe Int)), '("lhs", AttrOpt SymbolHandle),
        '("rhs", AttrOpt SymbolHandle)]
...
type instance ParameterList "softmax(symbol)" =
     '[ '("axis", AttrOpt Int),
        ...
        '("dtype",
          AttrOpt (Maybe (EnumType '["float16", "float32", "float64"]))),
        '("use_length", AttrOpt (Maybe Bool)),
        '("data", AttrOpt SymbolHandle), '("length", AttrOpt SymbolHandle)]
...
softmax name args
  = let scalarArgs
        ...
        tensorArgs
          = catMaybes
              [("data",) <$> (args !? #data :: Maybe SymbolHandle),
               ("length",) <$> (args !? #length :: Maybe SymbolHandle)]
        (tensorkeys, tensorvals) = unzip tensorArgs
      in
